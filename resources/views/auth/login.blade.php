...
@section('content')
<div class="bg-slate-50 py-12 pt-28 min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email') }}"
                            class="appearance-none block w-full px-4 py-2 border border-slate-300 rounded-lg shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>
                </div>
