<div class="fixed bottom-0 left-0 w-full bg-gradient-to-r from-orange-500 to-red-500 border-t border-orange-600 shadow-xl z-50 md:hidden pb-safe">
    <div class="flex justify-around items-center h-16">
        <!-- Home -->
        <a href="{{ url('/') }}" class="flex flex-col items-center justify-center w-full h-full text-orange-100 hover:text-white transition-colors group">
        ...
        <a href="{{ url('/about-us') }}" class="flex flex-col items-center justify-center w-full h-full text-orange-100 hover:text-white transition-colors group">
            ...
            <span class="text-[10px] font-medium tracking-wide uppercase">About</span>
        </a>
        ...
        <!-- Academics -->
        <a href="{{ url('/#academics') }}" class="flex flex-col items-center justify-center w-full h-full text-orange-100 hover:text-white transition-colors group">
            <svg class="w-6 h-6 mb-1 group-hover:-translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
            </svg>
            <span class="text-[10px] font-medium tracking-wide uppercase">Academics</span>
        </a>
        ...
        <a href="{{ url('/contact') }}" class="flex flex-col items-center justify-center w-full h-full text-orange-100 hover:text-white transition-colors group">
            ...
            <span class="text-[10px] font-medium tracking-wide uppercase">Contact</span>
        </a>
    </div>
</div>
