        ...
        <div x-show="open" 
            ...
            <div x-data="{ aboutOpen: {{ request()->is('about-us') || request()->is('aboutus/*') ? 'true' : 'false' }} }" class="space-y-1">
                ...
                <div x-show="aboutOpen" x-transition class="pl-4 space-y-1 border-l-2 border-orange-100 ml-4 mt-0.5" style="display: none;">
                    <a href="{{ url('/aboutus/establishment-objecties') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->is('aboutus/establishment-objecties') ? 'text-orange-600 font-bold bg-orange-50/50' : 'text-slate-600 hover:bg-slate-50 font-semibold' }}">Establishment & Objectives</a>
            ...
            <nav class="hidden md:flex gap-8 items-center">
                ...
                <div class="relative group py-2">
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-56 rounded-2xl bg-white/95 backdrop-blur-md shadow-2xl py-2.5 border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 transform translate-y-2 group-hover:translate-y-0">
                        <a href="{{ url('/aboutus/establishment-objecties') }}" class="block px-5 py-2.5 text-sm {{ request()->is('aboutus/establishment-objecties') ? 'text-orange-600 bg-orange-50 font-bold' : 'text-slate-700 hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 hover:text-white transition-colors font-semibold' }}">Establishment & Objectives</a>
